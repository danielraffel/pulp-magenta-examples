...
| Demo | Kind | Status |
|------|------|--------|
| Promptable Accompanist (E1) | MIDI-conditioned generative instrument | **working, cross-format** — **AU (auval PASSES) + VST3 + CLAP + Standalone(.app)** — installable in Logic; generates from prompt + takes MIDI; links `magentart::core` |
